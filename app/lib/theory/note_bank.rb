...
module Theory
  class NoteBank
    def initialize(_options = {})
      ...
      @notes.push Note.new(name: 'C♯', alt_name: 'D♭', alias: '2', natural: false, color: '#2bfda6', text_color: 'black')
      @notes.push Note.new(name: 'D', alias: '3', natural: true, color: '#acef39', text_color: 'black')
      @notes.push Note.new(name: 'D♯', alt_name: 'E♭', alias: '4', natural: false, color: '#2ecc35', text_color: 'black')
      ...
      @notes.push Note.new(name: 'F♯', alt_name: 'G♭', alias: '7', natural: false, color: '#2ca8d3', text_color: 'white')
      @notes.push Note.new(name: 'G', alias: '8', natural: true, color: '#4d56fb', text_color: 'white')
      @notes.push Note.new(name: 'G♯', alt_name: 'A♭', alias: '9', natural: false, color: '#a37dfc', text_color: 'white')
      @notes.push Note.new(name: 'A', alias: '10', natural: true, color: '#9b3ce9', text_color: 'white')
      @notes.push Note.new(name: 'A♯', alias: '11', alt_name: 'B♭', natural: false, color: '#f3f136', text_color: 'black')
